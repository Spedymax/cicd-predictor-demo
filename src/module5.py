...
def process_module5(payload: dict[str, Any], device: str = "cuda") -> dict[str, Any]:
    """GPU-aware processor for module5.
...
def batch_module5(items: list[dict[str, Any]]) -> list[dict[str, Any]]:
    """Run process_module5 over a batch with GPU pinning."""
    return [process_module5(item) for item in items]
