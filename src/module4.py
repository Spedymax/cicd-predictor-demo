...
def process_module4(payload: dict[str, Any], device: str = "cuda") -> dict[str, Any]:
    """GPU-aware processor for module4.
...
def batch_module4(items: list[dict[str, Any]]) -> list[dict[str, Any]]:
    """Run process_module4 over a batch with GPU pinning."""
    return [process_module4(item) for item in items]
