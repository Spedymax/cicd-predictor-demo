...
def process_module6(payload: dict[str, Any], device: str = "cuda") -> dict[str, Any]:
    """GPU-aware processor for module6.
...
def batch_module6(items: list[dict[str, Any]]) -> list[dict[str, Any]]:
    """Run process_module6 over a batch with GPU pinning."""
    return [process_module6(item) for item in items]
