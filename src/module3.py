...
def process_module3(payload: dict[str, Any], device: str = "cuda") -> dict[str, Any]:
    """GPU-aware processor for module3.
...
def batch_module3(items: list[dict[str, Any]]) -> list[dict[str, Any]]:
    """Run process_module3 over a batch with GPU pinning."""
    return [process_module3(item) for item in items]
