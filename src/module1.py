...
def process_module1(payload: dict[str, Any], device: str = "cuda") -> dict[str, Any]:
    """GPU-aware processor for module1.
...
def batch_module1(items: list[dict[str, Any]]) -> list[dict[str, Any]]:
    """Run process_module1 over a batch with GPU pinning."""
    return [process_module1(item) for item in items]
